package com.financeiro.backend.resources.exceptions;
...
public class ResourceExceptionHandler {
    ...
    @ExceptionHandler
    public ResponseEntity<StandardError> objectrNotFoundException(ObjectNotFoundException ex, HttpServletRequest request){
